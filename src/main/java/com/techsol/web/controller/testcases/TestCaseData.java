package com.techsol.web.controller.testcases;
...
public class TestCaseData {
    ...
    @HTTPPath(path = "/test-cases-files")
    public void testCasesFiles(HTTPRequest request, HTTPResponse httpResponse) throws IOException {
        PebbleTemplate template = new PebbleEngineProvider().getPebbleEngine()
                .getTemplate(Constants.TEMPLATES_PATH + "testcases"
                        + Constants.FILE_SEPARATOR + "testcasefiles.peb");
